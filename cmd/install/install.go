...
func (o *Options) validateMiscConfig() []error {
	...
	if hasAnyRoleARN {
		...
		case "web-identity", "ec2-instance-metadata":
		default:
			errs = append(errs, fmt.Errorf("--aws-role-credential-source must be 'web-identity' or 'ec2-instance-metadata', got %q", o.AWSRoleCredentialSource))
		}
	}
...
func NewCommand() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&opts.AWSRoleCredentialSource, "aws-role-credential-source", "web-identity", "Credential source for AWS role ARN flags: 'web-identity' (uses projected SA token) or 'ec2-instance-metadata' (uses EC2 instance metadata)")
...
func setupExternalDNS(opts Options, operatorNamespace *corev1.Namespace) ([]crclient.Object, error) {
	...
	useWebIdentity := opts.ExternalDNSRoleARN != "" && opts.AWSRoleCredentialSource == "web-identity"
...
func awsRoleCredentialFileContent(roleARN, credentialSource string) string {
	if credentialSource == "ec2-instance-metadata" {
