...
// WithIngressRoleARN sets the IngressRoleARN field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the IngressRoleARN field is set to the value of the last call.
func (b *AWSSharedVPCApplyConfiguration) WithIngressRoleARN(value string) *AWSSharedVPCApplyConfiguration {
	b.IngressRoleARN = &value
	return b
}

// WithControlPlaneRoleARN sets the ControlPlaneRoleARN field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
